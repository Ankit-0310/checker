...
$videoURLStart = "https://t.me/cyberpunk_bio/2";


if (preg_match('/^(\/start|\.start|!start)/', $text)) {
    if (in_array($userId, $freeusers)) {
        $caption = "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 <code>@$username</code> 𝘁𝗼 ꜱ ʏ ɴ ᴛ ᴀ x x Checker 💖
        ...
        'inline_keyboard' => [
            [
                             ['text' => '𝙂𝘼𝙏𝙀𝙒𝘼𝙔𝙎', 'callback_data' => 'gates'],
                                 ...
                                 [
                                 ['text' => 'Cyberpunk', 'callback_data' => 'channel'],
                             ],
        ]
    ]);

    $caption = "Welcome To   ꜱ ʏ ɴ ᴛ ᴀ x x .  Buy The Plan First.  /price 
...

{
 ...
 $caption=" Pricing ꜱ ʏ ɴ ᴛ ᴀ x x Checker📍
━━━━━━━━━━━━━━━━━━
⑄ 𝙎𝙐𝘽𝙎𝘾𝙍𝙄𝙋𝙏𝙄𝙊𝙉 𝙈𝙀𝙉𝙐 ⑄
━━━━━━━━━━━━━━━━━━
× 1 𝘞𝘌𝘌𝘒  - 3$
...
━━━━━━━━━━━━━━━━━━
⚠️ 𝘕𝘰𝘵𝘦- For Indian user payment method will be different
